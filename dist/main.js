...
$templateCache.put("views/notifications.directive.html","<div class=\"notification\">100</div>");}]);
(function() {
  'use strict';
...
(function() {
  ...
  NotificationsController = function($scope, ThreadsService) {
    var activate, onChange, vm;
    vm = this;
    onChange = function(threadsVm) {
      return vm.unreadCount = threadsVm.unreadCount;
    };
    activate = function() {
      ...
      $scope.$watch('subscriberId', function() {
        ...
        if ($scope.subscriberId.length) {
          return ThreadsService.get(params, onChange);
        }
      });
      return vm;
    };
